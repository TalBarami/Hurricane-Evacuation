...
namespace HurricaneEvacuation.SimulatorEnvironment.Tests
{
    class ManualTests
    {
        ...
        public void Test1()
        {
            ...
            var settings = new CodeSettings(graph, agents, deadline, 1, -1);
            ...
            //agents.Add(new AStarAgent(1, settings, graph.Vertices[0]));
        ...
        public void Test2()
        {
            ...
            var settings = new CodeSettings(graph, agents, deadline, k, -1);
            agents.Add(new VandalAgent(2, settings, graph.Vertices[3], 5));
            agents.Add(new GreedyAgent(1, settings, graph.Vertices[1]));;
